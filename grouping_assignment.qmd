...
**The most common category was merchant fees. I grouped by disbursement description, and summarized with a new variable count. I arranged in descending order to find the highest value.**
...
**Michael Glassner received the most in Payroll with \$499000. I filtered to only include Glassner. Then I grouped by disbursement description, summarized by the total disbursement amount, and arranged by disbursement amount in descending order to find the highest possible value.**
